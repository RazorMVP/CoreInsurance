...
| 6 | Reinsurance | 17 | RI allocations, offer slips, credit notes, bordereaux; **inward FAC (V75)** — accept/renew/extend/cancel a ceding insurer's share, server-side guaranty document, premium receivable (DebitNote + `FAC_PREMIUM_ACCEPTED` GL), live `/api/v1/ri/fac-inwards` + FACTab Inward tab |
...
| Inward Facultative | Managed in Reinsurance module — **built V75**: accept a ceding insurer's share of a risk → server-side guaranty document + premium receivable (DebitNote, `Dr 1330 / Dr 5240 / Cr 4330`, simple income posting — not IFRS-17 PAA, matching outward FAC). `/api/v1/ri/fac-inwards` create/renew/extend/cancel; no local policy (external risk), ceding company = insurers master data |
...
FAC inward (accepted)  → Debit Note      → Finance Receivables → Receipt   (V75; Dr 1330 / Dr 5240 / Cr 4330)
```
