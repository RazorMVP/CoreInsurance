...
| `[x]` | Custom Report Builder | CustomReportBuilderPage — 3-step stepper: Step1DataSource (16 data sources incl. closures + `RM_COMMISSION`), Step2FieldsFilters (field picker + computed field badges + date filter toggles), Step3Visualisation (chart type cards + axis selectors + name + category); Save & Run navigates to viewer |
